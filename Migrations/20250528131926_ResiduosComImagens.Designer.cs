...
namespace EspacoVerde.Migrations
{
    ...
    [Migration("20250528131926_ResiduosComImagens")]
    partial class ResiduosComImagens
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EspacoVerde.Models.Transacao", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID_Transacao = 1,
                            Data_Transacao = new DateTime(2025, 5, 28, 10, 19, 26, 246, DateTimeKind.Local).AddTicks(194),
                            ID_Comprador = 2,
                            ID_Residuo = 1,
                            Preco_Final = 1500m
                        });
